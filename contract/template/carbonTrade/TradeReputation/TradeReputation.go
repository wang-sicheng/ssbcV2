...
func PullCarbonCreditData(args map[string]string) (interface{}, error) {
	cb := meta.Callback{
		Caller:   "",
		Value:    0,
...
func StartCarbonTrade(args map[string]string) (interface{}, error) {
	...
	credit, err := strconv.ParseFloat(dataMap["GlobalReputation"], 32)
	if err != nil {
...
// push碳交易链的局部信誉给碳征信链
func PushLocalReputation(args map[string]string) (interface{}, error) {
